...
send_stats() {
	...
	cpu_arch=$(uname -m)
	curl -s -X POST "https://www.akkdiy.cn/api/log" \
...
UserLicenseAgreement() {
	...
	echo "用户许可协议: https://www.akkdiy.cn/user-license-agreement/"
	echo -e "----------------------"
...
{
	"registry-mirrors": ["https://www.akkdiy.cn"]
}
EOF
...
if [ "$country" = "CN" ]; then
	cd ~
	curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/dockeinstall && chmod +x install
...
install_ldnmp_conf() {
  ...
  wget -O /home/web/nginx.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/nginx10.conf
  wget -O /home/web/conf.d/default.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/main/default10.conf

  default_server_ssl

  # 下载 docker-compose.yml 文件并进行替换
  wget -O /home/web/docker-compose.yml ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/dockeLNMP-docker-compose-10.yml
...
install_certbot() {
	...
	# 下载并使脚本可执行
	curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/auto_cert_renewal.sh
...
reverse_proxy() {
	  ip_address
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/reverse-proxy.conf
...
cluster_python3() {
	cd ~/cluster/
	curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/python-for-vps/main/cluster/$py_task
...
f2b_install_sshd() {
	...
	if grep -q 'Alpine' /etc/issue; then
		...
		curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/alpine-sshd.conf
		curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/alpine-sshd-ddos.conf
		cd /path/to/fail2ban/config/fail2ban/jail.d/
		curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/alpine-ssh.conf
	elif command -v dnf &>/dev/null; then
		cd /path/to/fail2ban/config/fail2ban/jail.d/
		curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/centos-ssh.conf
	else
		install rsyslog
		systemctl start rsyslog
		systemctl enable rsyslog
		cd /path/to/fail2ban/config/fail2ban/jail.d/
		curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/linux-ssh.conf
	fi
}
			...
			while true; do
				  ...
				  case $sub_choice in
					  1)
						...
						wget -qO - ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/archive.key | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes

						# 步骤3：添加存储库
						echo 'deb [signed-by=/usr/share/keyrings/xanmod-archive-keyring.gpg] http://deb.xanmod.org releases main' | tee /etc/apt/sources.list.d/xanmod-release.list

						# version=$(wget -q https://dl.xanmod.org/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
						version=$(wget -q ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
...
linux_ldnmp() {
  ...
  while true; do
	...
	case $sub_choice in
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/wordpress.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/discuz.com.conf
	  ...
	  mkdir $yuming
	  cd $yuming
	  wget -O latest.zip ${gh_proxy}https://github.com/awahello/Website_source_code/raw/main/Discuz_X3.5_SC_UTF8_20240520.zip
	  unzip latest.zip
	  rm latest.zip
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/kdy.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/maccms.com.conf
	  ...
	  cd /home/web/html/$yuming/template/ && wget ${gh_proxy}https://github.com/awahello/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/$yuming/template/DYXS2.zip
	  cp /home/web/html/$yuming/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/$yuming/application/admin/controller
	  cp /home/web/html/$yuming/template/DYXS2/asset/admin/dycms.html /home/web/html/$yuming/application/admin/view/system
	  mv /home/web/html/$yuming/admin.php /home/web/html/$yuming/vip.php && wget -O /home/web/html/$yuming/application/extra/maccms.php ${gh_proxy}https://raw.githubusercontent.com/awahello/Website_source_code/main/maccms.php
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/dujiaoka.com.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/flarum.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/typecho.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/index_php.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/rewrite.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awahello/awa/blob/main/sh/nginx/reverse-proxy.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/reverse-proxy-domain.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/html.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	...
	33)
	  ...
	  cd ~
	  wget -O ${useip}_beifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/beifen.sh > /dev/null 2>&1
		...
		if docker inspect fail2ban &>/dev/null ; then
			  ...
			  case $sub_choice in
				  ...
				  21)
					  ...
					  wget -O /home/web/conf.d/default.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/default11.conf
					  docker restart nginx

					  cd /path/to/fail2ban/config/fail2ban/jail.d/
					  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/nginx-docker-cc.conf

					  cd /path/to/fail2ban/config/fail2ban/action.d
					  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/cloudflare-docker.conf

					  sed -i "s/awahello@outlook.com/$cfuser/g" /path/to/fail2ban/config/fail2ban/action.d/cloudflare-docker.conf
				  ...
				  22)
					  ...
					  install jq bc
					  check_crontab_installed
					  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/CF-Under-Attack.sh
			...
			wget -O /home/web/nginx.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/nginx/nginx10.conf
			wget -O /home/web/conf.d/default.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/default10.conf
			default_server_ssl
			nginx_upgrade

			f2b_install_sshd
			cd /path/to/fail2ban/config/fail2ban/filter.d
			curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/fail2ban-nginx-cc.conf
			cd /path/to/fail2ban/config/fail2ban/jail.d/
			curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/config/fail2ban/nginx-docker-cc.conf
	...
	36)
		  while true; do
			  ...
			  case $sub_choice in
				  ...
				  # php调优
				  wget -O /home/optimized_php.ini ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/optimized_php.ini
				  docker cp /home/optimized_php.ini php:/usr/local/etc/php/conf.d/optimized_php.ini
				  docker cp /home/optimized_php.ini php74:/usr/local/etc/php/conf.d/optimized_php.ini
				  rm -rf /home/optimized_php.ini

				  # php调优
				  wget -O /home/www.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/www-1.conf
				  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
				  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
				  rm -rf /home/www.conf

				  # mysql调优
				  wget -O /home/custom_mysql_config.cnf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/custom_mysql_config-1.cnf
				  ...
				  # php调优
				  wget -O /home/www.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/www.conf
				  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
				  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
				  rm -rf /home/www.conf

				  # mysql调优
				  wget -O /home/custom_mysql_config.cnf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/custom_mysql_config.cnf
				  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
				  rm -rf /home/custom_mysql_config.cnf
			...
			while true; do
				...
				case $choice in
					1)
						...
						curl -o /home/docker/cloud/docker-compose.yml ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/dockecloudreve-docker-compose.yml
...
EOF
		  ...
		  21)
			  ...
			  while true; do
				  ...
				  case $host_dns in
					  1)
						  read -e -p "请输入新的解析记录 格式: 110.25.5.33 awahello.com : " addhost
			...
			while true; do
				...
				case "$Limiting" in
				  1)
					...
					cd ~
					curl -Ss -o ~/Limiting_Shut_down.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/Limiting_Shut_down1.sh
			  ...
			  case "$choice" in
				[Yy])
				  ...
				  if [ -f ~/TG-check-notify.sh ]; then
					  ...
					  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/TG-check-notify.sh
					  chmod +x ~/TG-check-notify.sh
					  nano ~/TG-check-notify.sh
				  fi
				  ...
				  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/TG-SSH-check-notify.sh > /dev/null 2>&1
		  ...
		  26)
			  ...
			  cd ~
			  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/upgrade_openssh9.8p1.sh
...
awahello_update() {
	...
	echo "更新日志"
	echo "------------------------"
	echo "全部日志: ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/awahello_sh_log.txt"
	echo "------------------------"

	curl -s ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/awahello_sh_log.txt | tail -n 35
	sh_v_new=$(curl -s ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/awash.sh | grep -o 'sh_v="[0-9.]*"' | cut -d '"' -f 2)
	...
	if [ "$sh_v" = "$sh_v_new" ]; then
		...
		case "$choice" in
			[Yy])
				...
				country=$(curl -s ipinfo.io/country)
				if [ "$country" = "CN" ]; then
					curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/cn/awash.sh && chmod +x awash.sh
				else
					curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/awash.sh && chmod +x awash.sh
				fi
				CheckFirstRun_true
				yinsiyuanquan2
				cp -f ./awash.sh /usr/local/bin/k > /dev/null 2>&1
...
case $choice in
  ...
  p) send_stats "幻兽帕鲁开服脚本" ; cd ~
	 curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/main/sh/palworld.sh ; chmod +x palworld.sh ; ./palworld.sh
	 exit
	 ;;
  00) awahello_update ;;
  0) clear ; exit ;;
