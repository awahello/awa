...
UserLicenseAgreement() {
	clear
	echo -e "${gl_kjlan}欢迎使用awa脚本工具箱${gl_bai}"
	...
	if [ "$user_input" = "y" ] || [ "$user_input" = "Y" ]; then
		send_stats "许可同意"
		sed -i 's/^permission_granted="false"/permission_granted="true"/' ./awash.sh
...
if [ "$country" = "CN" ]; then
	cd ~
	curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/docker/install && chmod +x install
...
install_ldnmp_conf() {
  ...
  wget -O /home/web/nginx.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/nginx10.conf
  wget -O /home/web/conf.d/default.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/default10.conf

  default_server_ssl

  # 下载 docker-compose.yml 文件并进行替换
  wget -O /home/web/docker-compose.yml ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/docker/LNMP-docker-compose-10.yml
  dbrootpasswd=$(openssl rand -base64 16) ; dbuse=$(openssl rand -hex 4) ; dbusepasswd=$(openssl rand -base64 8)

  # 在 docker-compose.yml 文件中进行替换
  sed -i "s#webroot#$dbrootpasswd#g" /home/web/docker-compose.yml
  sed -i "s#awahelloYYDS#$dbusepasswd#g" /home/web/docker-compose.yml
  sed -i "s#awahello#$dbuse#g" /home/web/docker-compose.yml
...
install_certbot() {
	...
	# 下载并使脚本可执行
	curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/auto_cert_renewal.sh
...
reverse_proxy() {
	  ip_address
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/reverse-proxy.conf
...
phpmyadmin_upgrade() {
  ...
  docker rm -f $ldnmp_pods > /dev/null 2>&1
  docker images --filter=reference="$ldnmp_pods*" -q | xargs docker rmi > /dev/null 2>&1
  curl -sS -O https://raw.githubusercontent.com/zaixiangjian/docker/refs/heads/main/docker-compose.phpmyadmin.yml
...
root_use() {
clear
[ "$EUID" -ne 0 ] && echo -e "${gl_huang}提示: ${gl_bai}该功能需要root用户才能运行！" && break_end && awahello
}
...
dd_xitong() {
		send_stats "重装系统"
		dd_xitong_MollyLau() {
			wget --no-check-certificate -qO InstallNET.sh "${gh_proxy}https://raw.githubusercontent.com/awahello/awa/blob/main/sh/Tools/Linux_reinstall/InstallNET.sh" && chmod a+x InstallNET.sh
			...
			while true; do
				  ...
				  case $sub_choice in
					  1)
						...
						wget -qO - ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/archive.key | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes

						# 步骤3：添加存储库
						echo 'deb [signed-by=/usr/share/keyrings/xanmod-archive-keyring.gpg] http://deb.xanmod.org releases main' | tee /etc/apt/sources.list.d/xanmod-release.list

						# version=$(wget -q https://dl.xanmod.org/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
						version=$(wget -q ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
...
linux_ldnmp() {
  ...
  while true; do
	...
	case $sub_choice in
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/wordpress.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/discuz.com.conf
	  ...
	  mkdir $yuming
	  cd $yuming
	  wget -O latest.zip ${gh_proxy}https://github.com/zaixiangjian/Website_source_code/raw/main/Discuz_X3.5_SC_UTF8_20240520.zip
	  unzip latest.zip
	  rm latest.zip
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/kdy.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/maccms.com.conf
	  ...
	  cd /home/web/html/$yuming/template/ && wget ${gh_proxy}https://github.com/zaixiangjian/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/$yuming/template/DYXS2.zip
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/dujiaoka.com.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/flarum.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/typecho.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/index_php.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/rewrite.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/reverse-proxy-domain.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/html.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	...
	33)
	  ...
	  cd ~
	  wget -O ${useip}_beifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/beifen.sh > /dev/null 2>&1
		...
		if docker inspect fail2ban &>/dev/null ; then
			  ...
			  case $sub_choice in
				  ...
				  21)
					  ...
					  wget -O /home/web/conf.d/default.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/nginx/default11.conf
					  docker restart nginx
				  ...
				  22)
					  ...
					  install jq bc
					  check_crontab_installed
					  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/CF-Under-Attack.sh
			...
			f2b_install_sshd
			cd /path/to/fail2ban/config/fail2ban/filter.d
			curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/fail2ban-nginx-cc.conf
			cd /path/to/fail2ban/config/fail2ban/jail.d/
			curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/zaixiangjian/config/main/fail2ban/nginx-docker-cc.conf
	...
	36)
		  while true; do
			  ...
			  case $sub_choice in
				  ...
				  # php调优
				  wget -O /home/optimized_php.ini ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/optimized_php.ini
				  docker cp /home/optimized_php.ini php:/usr/local/etc/php/conf.d/optimized_php.ini
				  docker cp /home/optimized_php.ini php74:/usr/local/etc/php/conf.d/optimized_php.ini
				  rm -rf /home/optimized_php.ini

				  # php调优
				  wget -O /home/www.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/www-1.conf
				  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
				  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
				  rm -rf /home/www.conf

				  # mysql调优
				  wget -O /home/custom_mysql_config.cnf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/custom_mysql_config-1.cnf
				  ...
				  # php调优
				  wget -O /home/www.conf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/www.conf
				  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
				  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
				  rm -rf /home/www.conf

				  # mysql调优
				  wget -O /home/custom_mysql_config.cnf ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/custom_mysql_config.cnf
				  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
				  rm -rf /home/custom_mysql_config.cnf
		...
		6)
		  ...
		  7)
			...
			while true; do
				...
				case $choice in
					1)
						curl -L https://raw.githubusercontent.com/zaixiangjian/nezhav0/refs/heads/v0/install.sh -o nezha.sh && chmod +x nezha.sh && sudo ./nezha.sh
						;;
					0)
						break
						;;
			...
			while true; do
				...
				case $choice in
					1)
						...
						curl -o /home/docker/cloud/docker-compose.yml ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/docker/cloudreve-docker-compose.yml
		  ...
		  54)
			while true; do
				...
				case $choice in
					1)
						# 安装
						if [ ! -d /home/docker/webssh ]; then
							mkdir -p /home/docker/webssh > /dev/null 2>&1
						fi

						wget -O /home/docker/webssh/webssh_linux_amd64 https://github.com/zaixiangjian/ziyongcdn/releases/download/1.29/webssh_linux_amd64 > /dev/null 2>&1
						chmod +x /home/docker/webssh/webssh_linux_amd64

						password=$(tr -dc 'A-Za-z0-9' </dev/urandom | head -c 18)

						pkill -f /home/docker/webssh/webssh_linux_amd64 > /dev/null 2>&1 || true

						nohup /home/docker/webssh/webssh_linux_amd64 -p 5032 -a admin:$password >/dev/null 2>&1 &

						crontab -l 2>/dev/null | grep -v '/home/docker/webssh/webssh_linux_amd64' > /tmp/crontab.$$
						echo "@reboot sleep 10 && nohup /home/docker/webssh/webssh_linux_amd64 -p 5032 -a admin:$password >/dev/null 2>&1 &" >> /tmp/crontab.$$
						crontab /tmp/crontab.$$
						rm -f /tmp/crontab.$$

						echo
						echo "安装完成"
						echo "访问地址: http://$(hostname -I | awk '{print $1}'):5032"
						echo "账号: admin"
						echo "密码: $password"
						echo "密码只显示一次，请妥善保存！"
						read -p "按任意键返回菜单..."
					...
					2)
						# 重设密码
						if [ ! -x /home/docker/webssh/webssh_linux_amd64 ]; then
							echo "未检测到 webssh 服务，请先安装！"
							read -p "按任意键返回菜单..."
							continue
						fi
					...
					3)
						...
						echo "正在卸载 webssh..."
						pkill -f /home/docker/webssh/webssh_linux_amd64 > /dev/null 2>&1 || true
						crontab -l 2>/dev/null | grep -v '/home/docker/webssh/webssh_linux_amd64' | crontab -
						rm -rf /home/docker/webssh
						echo "卸载完成！"
						read -p "按任意键返回菜单..."
						;;
					0)
...
EOF
		...
		57)
		  ...
		  58)
		    clear
		    echo "▶️ 正在启动caddy安装..."
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/anzhuangcaddy.sh)
		    echo "✅ caddy安装完成。"
		    ;;
...
;;
		  ...
		  65)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/anzhuangcaddydnspeizhi.sh)
		  ...
		  66)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/anzhuangcaddydnspeizhipeizhiwenjian.sh)
		    echo "✅ caddy DNS配置版 。"
		    ;;
        ...
        ;;
		  ...
		  68)
		    clear
		    echo "▶️ 安装M38u8..."
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/m3u8xiazai.sh)
		    echo "✅ 安装M38u8完成 。"
		    ;;
	  ...
	  ;;
		  ...
		  72)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/discourse.sh)
		    echo "✅ 安装discourse论坛 。"
		    ;;
...
;;
		  ...
		  74)
		    clear
		    echo "▶️ 安装minio..."
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/minlo.sh)
		    echo "✅ 安装minio..."
		    ;;
...
;;
		  ...
		  77)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/mailnginxcaddy.sh)
		  ...
		  78)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/mailcaddy.sh)
...
;;
		  ...
		  90)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/btcpayserver-docker.sh)
		  ...
		  91)
		    clear
		    echo "▶️ 正在启动谷歌自动浏览..."
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zidongliulan.sh)
		    echo "✅ 谷歌自动浏览安装完成。"
		    ;;
...
EOF
		...
		99)
		  ...
		  100)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zidongbeifen.sh)
		    echo "✅ 远程备份与传送模块执行完成。"
		    ;;
		  ...
		  101)
		    clear
		    echo "▶️ 正在启动定时远程备份与传送模块..."
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zidongmima.sh)
		    echo "✅ 远程备份与传送模块执行完成。"
		    ;;
		  ...
		  102)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/win10ltls.sh)
		    echo "✅ 远程备份与传送模块执行完成。"
		    ;;
		  ...
		  104)
		    ...
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zidonghebinganzhuangjiaoben.sh)
		    echo "✅ 动105脚本必装模块执行完成。"
		    ;;
		  105)
		    clear
		    echo "▶️ 正在启动定时远程备份与传送模块..."
		    bash <(curl -fsSL https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zidonghebing.sh)
		    echo "✅ 远程备份与传送模块执行完成。"
		    ;;
...
linux_Settings() {
	...
	while true; do
	  ...
	  echo -e "${gl_kjlan}------------------------"
	  echo -e "${gl_kjlan}101. ${gl_bai}卸载awa脚本"
	  echo -e "${gl_kjlan}------------------------"
	  echo -e "${gl_kjlan}0.   ${gl_bai}返回主菜单"
	  echo -e "${gl_kjlan}------------------------${gl_bai}"
	  read -e -p "请输入你的选择: " sub_choice
...
EOF
			...
			while true; do
				...
				case "$Limiting" in
				  1)
					...
					cd ~
					curl -Ss -o ~/Limiting_Shut_down.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/Limiting_Shut_down1.sh
			  ...
			  case "$choice" in
				[Yy])
				  ...
				  if [ -f ~/TG-check-notify.sh ]; then
					  ...
					  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/TG-check-notify.sh
					  chmod +x ~/TG-check-notify.sh
					  nano ~/TG-check-notify.sh
				  fi
				  ...
				  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/TG-SSH-check-notify.sh > /dev/null 2>&1
		  ...
		  26)
			  ...
			  cd ~
			  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/upgrade_openssh9.8p1.sh
			...
			while true; do
			  ...
			  case $sub_choice in
				  1)
					  ...
					  sed -i 's/^ENABLE_STATS="false"/ENABLE_STATS="true"/' ./awash.sh
					  echo "已开启采集"
				  ...
				  2)
					  ...
					  sed -i 's/^ENABLE_STATS="true"/ENABLE_STATS="false"/' ./awash.sh
					  echo "已关闭采集"
...
EOF
		  ...
		  2)
			  ...
			  while true; do
				  ...
				  echo "------------------------"
				  echo "11. 安装awa脚本         12. 更新系统              13. 清理系统"
...
awahello_update() {
	...
	echo "更新日志"
	echo "------------------------"
	echo "全部日志: ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/awahello_sh_log.txt"
	echo "------------------------"

	curl -s ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/awahello_sh_log.txt | tail -n 35
	sh_v_new=$(curl -s ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/awash.sh | grep -o 'sh_v="[0-9.]*"' | cut -d '"' -f 2)
	...
	if [ "$sh_v" = "$sh_v_new" ]; then
		...
		case "$choice" in
			[Yy])
				...
				country=$(curl -s ipinfo.io/country)
				if [ "$country" = "CN" ]; then
					curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/cn/awash.sh && chmod +x awash.sh
				else
					curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/awash.sh && chmod +x awash.sh
				fi
				CheckFirstRun_true
				yinsiyuanquan2
				cp -f ./awash.sh /usr/local/bin/k > /dev/null 2>&1
...
echo -e "博客"
echo "------------------------"
echo -e "${gl_lan}RackNerd ${gl_bai}"
echo -e "${gl_bai}网址: https://www.akkdiy.cn/${gl_bai}"
echo "------------------------"
echo ""
echo -e "awa周边"
echo "------------------------"
echo -e "${gl_kjlan}B站:   ${gl_bai}https://www.akkdiy.cn/              ${gl_kjlan}导航:     ${gl_bai}https://www.akkdiy.cn/zimulu/daoh/${gl_bai}"
echo -e "${gl_kjlan}官网:  ${gl_bai}https://www.akkdiy.cn/             
echo -e "${gl_kjlan}博客:  ${gl_bai}https://www.akkdiy.cn/        
echo "------------------------"
echo ""
}
...
echo "/ /\ \ | | | | / /\ \ "
echo "\/  \/  \_/\_/ \/  \/ "
echo -e "awa脚本工具箱 v$sh_v 只为更简单的Linux的使用！"
...
case $choice in
  ...
  13) linux_Settings ;;
  14) linux_cluster ;;
  15) awahello_Affiliates ;;
  p) send_stats "幻兽帕鲁开服脚本" ; cd ~
	 curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/palworld.sh ; chmod +x palworld.sh ; ./palworld.sh
	 exit
	 ;;
  00) awahello_update ;;
  0) clear ; exit ;;
