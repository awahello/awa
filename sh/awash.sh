...
echo -e "${gl_bai}网址: https://awa.cn/topvps/${gl_bai}"
echo "------------------------"
echo ""
echo -e "域名优惠"
echo "------------------------"
...
echo -e "${gl_kjlan}官网:  ${gl_bai}https://awa.cn/               ${gl_kjlan}导航:     ${gl_bai}https://dh.awa.cn/${gl_bai}"
echo -e "${gl_kjlan}博客:  ${gl_bai}https://www.awa.cn/          ${gl_kjlan}软件中心: ${gl_bai}https://app.awa.cn/${gl_bai}"
echo "------------------------"
echo ""
}
