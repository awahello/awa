...
crontab -l 2>/dev/null | grep -E "beifen.x|chuansong.x|zidongtuchuang.x|wangpan.x|zixuanmulu.x" | nl | while read -r line; do
  ...
  if echo "$content" | grep -q "beifen.x"; then
    ...
    echo "$num. 其他任务: $content"
      ...
      echo "14. 在github修改目录https://github.com/awahello/awa/blob/main/shzixuanmulu2.sh"
      echo "------------------------"
      ...
      echo "98.V 论坛备份"
      echo "99.J 论坛备份"
      echo "999. 论坛恢复检测/home目录解压到/var只需要awash.sh  11 72  2重建即可"
      echo "------------------------"
      echo "188.全部备份传送同步本地"
...
111)
  ...
  wget -q -O beifenwhmcs.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/beifenwhmcs.sh
  chmod +x beifenwhmcs.sh

  sed -i "s/vpsip/$useip/g" beifenwhmcs.sh
  sed -i "s/vps密码/$usepasswd/g" beifenwhmcs.sh
  ...
  OUTPUT_BIN="/home/web/beifen/beifenwhmcs.x"
...
EOF
  ...
  rm -f "$TMP_SCRIPT" "$OBFUSCATED_SCRIPT" beifenwhmcs.sh
  ...
  ;;
        ...
        1)
          ...
          wget -q -O beifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/beifen.sh
          chmod +x beifen.sh
...
EOF
        ...
        2)
          ...
          wget -q -O chuansong.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/chuansong.sh
...
6)
    ...
    wget -q -O luntanbeifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/luntanbeifen.sh
...
7) 
    ...
    wget -q -O luntanbeifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/luntanbeifen1.sh
    chmod +x luntanbeifen.sh
...
9)
    ...
    wget -q -O beifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/mimabeifen.sh
    chmod +x beifen.sh
...
10)
    ...
    wget -q -O mimachuansong.sh https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/mimachuansong.sh
...
100)
    ...
    wget -q -O /home/web/vaultwarden/mimachuansong2.sh https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/mimachuansong2.sh
...
;;
        ...
        11)
          ...
          wget -q -O beifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zidongtuchuang.sh
          chmod +x beifen.sh
...
12)
  ...
  wget -q -O wangpan.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/wangpan.sh
  chmod +x wangpan.sh
...
nohup /home/docker/wangpan.x >/dev/null 2>&1 &
  ...
  ;;
        ...
        13)
          ...
          wget -q -O zixuanmulu.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zixuanmulu.sh
...
EOF
        ...
        14)
          ...
          wget -q -O zixuanmulu2.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/zixuanmulu2.sh
...
15)
    ...
    wget -q -O waibucunchu.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/waibucunchu.sh
...
17)
  ...
  # 下载脚本
  wget -q -O miniochuansong.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/miniochuansong.sh
...
EOF
  ...
  ;;
        ...
        98)
          ...
          # 下载备份脚本（统一文件名）
          wget -q -O discoursebeifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/discoursebeifenv.sh
...
EOF
        ...
        99)
          ...
          # 下载备份脚本（统一文件名）
          wget -q -O discoursebeifen1.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/discoursebeifenj.sh
...
188)
    ...
    wget -q -O quanbubeifen.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/quanbubeifen.sh
...
200)
    ...
    wget -q -O quanbubeifen2.sh ${gh_proxy}https://raw.githubusercontent.com/awahello/awa/refs/heads/main/sh/quanbubeifen2.sh
